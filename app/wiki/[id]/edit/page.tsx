...
export default function EditLore() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      alert('Failed to update lore. Please try again.')
      setSaving(false)
    }
  }
  ...
  async function handleDelete() {
    ...
    try {
      ...
      alert('Failed to delete lore. Please try again.')
    }
  }
    ...
    <div className="min-h-screen bg-gray-900 text-white p-4 md:p-8 font-sans">
      ...
      <div className="max-w-3xl mx-auto">
        <div className="border-b border-gray-700 pb-4 mb-8">
          <h1 className="text-4xl font-bold text-yellow-500 font-mono">EDIT LORE</h1>
          <p className="text-gray-400 mt-2">Modify existing knowledge</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full bg-gray-800 border border-gray-600 text-white px-4 py-3 rounded focus:outline-none focus:border-yellow-500 transition-colors"
          ...
          <div>
            ...
            <textarea
              ...
              required
              rows={12}
              className="w-full bg-gray-800 border border-gray-600 text-white px-4 py-3 rounded focus:outline-none focus:border-yellow-500 transition-colors font-mono text-sm resize-y"
          ...
          <div className="bg-gray-800 border border-gray-700 p-4 rounded">
            <label className="flex items-center gap-3 cursor-pointer">
              <input
                ...
                className="w-5 h-5 bg-gray-700 border-gray-600 rounded focus:ring-2 focus:ring-yellow-500"
              />
              <div>
          ...
          <div className="flex gap-4 pt-4">
            <button
              type="submit"
              disabled={saving}
              className="flex-1 bg-yellow-600 hover:bg-yellow-700 disabled:bg-gray-700 disabled:cursor-not-allowed text-white font-bold py-3 px-6 rounded transition-colors uppercase tracking-wider"
            >
